...
<html lang="en">
<head>
<title>ShopMate an Entertainment Contact </title>
<!-- for-mobile-apps -->
	...
	<div class="header">
		<div class="container">
			<div class="w3layouts_logo">
				<a href="index.php"><h1>ShopMate<span>Mobiles</span></h1></a>
			</div>
			<div class="w3_search">
		...
		<div class="faq">
			...
			<div class="container">
				...
				<div class="col-md-3 mail-wthree">
					...
					<h3>Email</h3>
					<h4><a href="mailto:info@example.com">kushal96@gmail.com</a></h4>
					<h4><a href="mailto:info@example.com">urvish@gmail.com</a></h4>
					<h4><a href="mailto:info@example.com">vignesh@gmail.com</a></h4>
				</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-7 w3ls_footer_grid1_right">
				<ul>
					<li>
						<a href="../web/index1.php">Mobiles</a>
					</li>
					<li>

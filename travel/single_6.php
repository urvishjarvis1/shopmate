		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>Madrid First Look</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div data-video="Rykmwn0SMWU" id="video"> <img src="images/madrid.jpg" alt="" class="img-responsive" /> </div>
						</div>
					</div>
						...
						<div class="media-grids">
							<div class="media">
								...
								<div class="media-body">
									<p>Great tours of the city.  Easily spent half a day getting on and off this bus.  There are two routes and both are included in the price.</p>
									<span>Certified User :<a href="#">Arjun Narsipur  </a></span>
								</div>
							</div>
							<div class="media">
								<h5>Mind-blowing tour</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>The 2 main routes (historical and modern) really do a good job of covering the city. However, it didn't work all the time. Not all jacks worked for the audio tour. The buses were often crowded (we had to wait for the next one more than once).  Also, the buses are supposed to stop running at 6:00, but we got to stop at 5:40 and never saw another.</p>
									<span>Certified User :<a href="#">Zachary Weinstein</a></span>
								</div>
							</div>
							<div class="media">
								<h5>Excellent Delivery and Cool Phone,...</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>The trees blocked almost all of the views so one ends up actually seeing nothing on the entire  tour unless you get down at every stop. If you have to do that one would rather just walk it anyway. </p>
									<span>Certified User :<a href="#">María de la Mora </a></span>
								</div>
							</div>
					...
					<div class="single-grid-right">
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_1museo_cerralbo.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Museo cerralbo</a>
				
								<p class="views">123664 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_plaza_de_cibeles.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Plaza De Cibeles</a>

								<p class="views">126315 views </p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_plaza_mayor.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Plaza Mayor</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_santiago-bernabeu.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Santiago Bernabeu</a>
							
								<p class="views">173694 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_thyssen-bornemisza.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Thyssen Bornemisza</a>
								
								<p class="views">136572 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_1monumento_a_alfonso_xii.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Monumento A Alfonso</a>
								
								<p class="views">121342 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-5 w3ls_footer_grid1_left">
				<p>&copy; 2016 ShopMate. All rights reserved | Design by <a href="http://google.com/">Kushal & Co.</a></p>
			</div>

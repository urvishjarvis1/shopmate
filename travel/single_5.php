		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>Kolkata First Look</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div data-video="451ZCdmbQ8U" id="video"> <img src="images/rsz_kolkata (2).jpg" alt="" class="img-responsive" /> </div>
						</div>
					</div>
					...
					<div class="all-comments">
						...
						<div class="media-grids">
							<div class="media">
								<h5>“Flexible two day touring options.”</h5>
								...
								<div class="media-body">
									<p>These tours give you the flexibility you need to explore Kolkatas sights; and rich cultural heritage a round city tour with stops where you can choose numerous locations on the list. Highlights for me included tagore house; mother house; queen victoria building and Kumatali. Guide was knowledgeable and tremense insight into the historrys rich heritage.</p>
									<span>Certified User :<a href="#">Lucinda P </a></span>
								</div>
							</div>
							<div class="media">
								<h5>“Very good ambience but... ”</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>Had been to Kolkata on my way to Hyderabad from Ranchi and decided to stay there for a day and booked through email well before and it was a planned one. We were well received by them and they have also arranged good guide and experienced driver and we are all set to start Kolkata as I heard is a...</p>
									<span>Certified User :<a href="#">josevell</a></span>
								</div>
							</div>
							<div class="media">
								<h5>“Very nice way of exploring the heritage properties of Kolkata! ”</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>Kolkata City Tours is basically a tour in which a tourist bus takes you to different heritage areas and heritage landmarks of Kolkata like Writer's Building, Calcutta High Court, Jain Mandir and many more. I always take guests in this tour as it is a great way of exploring the heritage properties of Kolkata.</p>
									<span>Certified User :<a href="#">MacKnightRider </a></span>
								</div>
							</div>
					...
					<div class="single-grid-right">
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_1victoria_memorial.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Victoria Memorial</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_1howrah_bridge.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Howrah Bridge</a>
								<p class="views">523468 views </p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_1kalighat_kali.jpeg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Kalighat Kali</a>
								<p class="views">456843 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_sundarbans.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Sundarbans</a>
								<p class="views">447984 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_1st_pauls_cathedral.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> 1st Pauls Cathedral</a>
								<p class="views">354435 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_1marble_palace.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Marble Palace</a>
								<p class="views">354322 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
				...
				<div id="owl-demo" class="owl-carousel owl-theme">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							...
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="single.php">Canada</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>2016</p>
									<div class="block-stars">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							...
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="index1.php">Kerala</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
									<p>2016</p>
									<div class="block-stars">

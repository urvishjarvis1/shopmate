				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							...
							<li><a href="index.php">Travelling</a></li>
						</ul>
					</nav>
				</div>
			</nav>	
		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>Australia First Look</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div data-video="vUF7ja9ehIs" id="video"> <img src="images/australia.jpg" alt="" class="img-responsive" /> </div>
						</div>
					</div>
						...
						<div class="media-grids">
							<div class="media">
								...
								<div class="media-body">
									<p>The lost beautiful place i liked is the great barrier reef. the water is best and also the whiteheaven beach is also good.</p>
									<span>Certified User :<a href="#">craig W</a></span>
								</div>
							</div>
							<div class="media">
								<h5>mind-blowing place for honeymoon.</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>The best thing I liked about this country is the atmosphere. The Hotels are at the prefect place and also the people living over here are very cooperative. I also love he food over here.</p>
									<span>Certified User :<a href="#">Alexender Stone</a></span>
								</div>
							</div>
					...
					<div class="single-grid-right">
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_1the_great_ocean_road.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> The Great Ocean Road</a>

								<p class="views">343434 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_sydney_opera_house.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Sydney Opera House</a>
								<p class="views">4214532 views </p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_the_great_barrier_reef.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">The Great Barrier Reef</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_twelve_apostles.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Twelve Apostles</a>
								<p class="views">458742 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_wave_rock.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Wave Rock</a>
								<p class="views">243568 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_whiteheaven_beach.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Whiteheaven Beach</a>
								<p class="views">3434314 views</p>
							</div>
							<div class="clearfix"> </div>
						</div>

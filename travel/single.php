				...
				<div class="col-sm-8 single-left">
					<div class="song">
						...
						<div class="video-grid-single-page-agileits">
							<div data-video="MUzk3uY09Zw" id="video"> <img src="images/rsz_colosseum1 (2).jpg" alt="" class="img-responsive" /> </div>
						</div>
					</div>
					...
					<div class="all-comments">
						...
						<div class="media-grids">
							<div class="media">
								<h5>Wow, I'll definitely use this as a guide on my trip. My May trip coincidently!</h5>
								...
								<div class="media-body">
									<p>You can Google Vatican museum tickets (biglietteria.vatican?) and colloseum tickets (includes forum) and it'll come out. There's a 4 euro fee for the Vatican, but it's best to these tickets online as it allows you to skip the lines (I've read it's quite long if you don't get out there early). On the way to Rome myself. Happy travels!</p>
									<span>Certified User :<a href="#">Romesh M </a></span>
								</div>
							</div>
							<div class="media">
								<h5>“Early Access Vatican Tour, Spot On!”</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>We decided to do the early access Vatican Tour with Real Rome Tours and are so glad we did. Our guide whose name a can't recall was a historian and was full of knowledge, he... read more
Review collected in partnership with this attraction </p>
									<span>Certified User :<a href="#">Sean S</a></span>
								</div>
							</div>
							<div class="media">
								<h5>“Brought Rome and The Colliseum to life”</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>Very happy with the service from Rome Tours - communications and information on where to find the guide and start location were excellent. We did the Colliseum and Forum tour, which we had previously done on our own.</p>
									<span>Certified User :<a href="#">Jennifer L </a></span>
								</div>
							</div>
					...
					<div class="single-grid-right">
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_1vatican_museum.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Vatican Museum</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_campo_dei_fiori.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Campo de' Fiori</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_castel_sant_angelo.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Castel Sant'Angelo</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_galleria_borghese.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Galleria Borghese</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_sistine_chapel.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Sistine Chapel</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_trevifountain.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Trevi Fountain</a>

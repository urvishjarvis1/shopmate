		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>Canada First Look</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div data-video="aE43SG5Q7DA" id="video"> <img src="images/toronto.jpg" alt="" class="img-responsive" /> </div>
						</div>
					</div>
						...
						<div class="media-grids">
							<div class="media">
								...
								<div class="media-body">
									<p>Kamloops B.C. Scott’s Inn and Restaurant “Its easy to see that Scott’s Inn is a believer in first impressions.” This is a “Stars of Tourism” Promotion Click to View Scott’s Inn and Restaurant .</p>
									<span>Certified User :<a href="#">Jacob M </a></span>
								</div>
							</div>
							<div class="media">
								<h5>Classy Canada</h5>
								...
								<div class="media-body">
									<p>I worked at City of Toronto part-time
										Pros
										Great diverse staff and overall a pleasant work environment!
										Cons
										The bureacracy with getting contracts or becoming a permanent employee. Lots of red tapes and rules
										Advice to Management
										If you want to have the best and keep the best re consider how contracts are awarded</p>
									<span>Certified User :<a href="#">Theunknowncorpion</a></span>
								</div>
							</div>
							<div class="media">
								<h5>just in love with this country...</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>Worth the money.... clean country,preserved heritages,appreciable spots to watch. obvoiusly,not romantic as paris!!</p>
									<span>Certified User :<a href="#">Rakesh Gupta </a></span>
								</div>
							</div>
					...
					<div class="single-grid-right">
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_banff.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Banff</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_churchill.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Churchill</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_lake_louise.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Lake Louise</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_niagara_falls.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Niagara falls</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_quebec_city.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title">Quebec City</a>
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="index1.php"><img src="images/rsz_torontoo.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="index1.php" class="title"> Canada</a>

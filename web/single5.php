...
include 'inc/dbh.php';
$sql = "SELECT * FROM price where name='motoz'";
		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>Moto Z Play First Look</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div data-video="cxv4x0XlMGM" id="video"> <img src="images/motoz.png" alt="" class="img-responsive" /> </div>
						</div>
					</div>
						...
						<div class="media-grids">
							<div class="media">
								...
								<div class="media-body">
									<p>this is my first moto device........after watching so much review at you tube finally . i decided two devices zenfone 3 nd moto z play in my budget(25000). then selected moto due to dual sim as well as nougat update . its awesome look as as well pure stock android, decent camera ,and powerful battery . cons-lake of OIS, low light camera performance is not up to the mark,headphone provided in the box is very cheap. overall very good buy at this price range......</p>
									<span>Certified Buyer :<a href="#">Satyam Kumar </a></span>
								</div>
							</div>
							<div class="media">
								...
								<div class="media-body">
									<p>Got this phone yesterday and I tell you this phone is amazing. First of all great thanks to flipkart for delivering it on the next day of release.
So let me start with pros and cons
Pros:
1. No need to say it separately but a modular concept itself is a big plus for this phone. You can add extra battery, projector, speaker ,or even a camera.
2. Battery life: I haven't charged this phone since I started it yesterday and their is still over 20% battery remaining.
3. Screen: Screen clarity is crisp and sharp the brightness great as well.
4. Camera: Camera quality is way ahead then any of the moto phones out their you can't compare it with iPhone though.
5. Finger print scanner: It's really fast in detecting your fingerprint.

Cons:
1. I feel the phone is a bit thick and a bit bulky that's because of the 3000 mAh battery.
2. I miss put your phone on vibrate when I reach my office which was present in my moto x now you have just talk to me.

Its just been a day and I am already in love with this phone. I'll test it a bit more and update my review.

I would say fir everyone who thinks of buying this phone to close their eyes and go for it great value for money phone.</p>
									<span>Certified Buyer :<a href="#">Rashmin Kawatkar </a></span>
								</div>
							</div>
							<div class="media">
								<h5>Review after 2 days use</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>What I expected from phone :-
Good Display
Best battery life
Smooth Operation
Stylish look
Better Camera
Where I'm with regards to my expectations :-
Display is really nice. It not something I'm missing about my old Galaxy note as its par with that.
Battery life is very good with 8-10 hrs of very normal use the battery was still 68%.By normal use I mean :- watsapp, video streaming (15-20 mins), Camera use (15 mins), and other trivial things like attended + dialled 3-4 calls etc.,
I use market application and some learning apps and there was no issues while multitasking. The switching was smooth and did not observe any lags for the same. I don't play games so can't give you idea on response for same.
Mobile is very stylish with the free style mod that I've got. Style and looks are subjective but very few will disagree with me on moto z's style. Camera quality is very good compared to the price range it is coming in. I'm probably one who captures memories more in in memory than in phone. It was not very big criterion for me but z play's camera quality is impressive compared to my old galaxy note. Video recording gets a bit of hit. I think compared to photos; videos are (bit) inferior in quality.
Other Observations :-
Turbo Charger works super fast. I had struggled with my old phone and other phone when it comes to charging but this one was pretty good. I found that phone heats up while charging (with usage). I'm no very sure about the sequence but it did heat up more than normal while charging and later when I kept it aside the mobile was cold (no heat was felt). I need to check this once again. In two days max I can observe it was for 2 times. 
I hope this review helps some of you. I'll update this review later once I've more experience with the device. Feel free to mark useful if you find so. Thanks</p>
									<span>Certified Buyer :<a href="#">Rohan Strike </a></span>
								</div>
							</div>

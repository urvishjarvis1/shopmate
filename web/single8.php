...
include 'inc/dbh.php';
$sql = "SELECT * FROM price where name='z5pre'";
		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>Xperia Z5 Premium First Look</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div data-video="PG2JLelx5qA" id="video"> <img src="images/xperia-z5.jpg" alt="" class="img-responsive" /> </div>
						</div>
					</div>
					...
					<div class="all-comments">
						...
						<div class="media-grids">
							<div class="media">
								<h5>Excellent Premium Flagship Smartphone</h5>
								...
								<div class="media-body">
									<p>Superb flagship phone by SONY...
Have been using this phone since 11 months (bought it on launch day) and totally satisfied with its killers looks and superb performance.
No complaints about anything, may be I might have paid higher (60 K) because of my habit of buying on launch day oly.
I would definitely recommend this phone for users of other brands (incl. Apple) and Sony users who think of getting upgraded to flagship phones.</p>
									<span>Certified Buyer :<a href="#">Amazon Customer </a></span>
								</div>
							</div>
							<div class="media">
								<h5>Sony always better than Samsung</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>Better Than Samsung device because it doesn't start lagging after 8month heavy usage also.
Though some better issue but accepted as my high usage.
But rather than battery Awesome Premium phone.</p>
									<span>Certified Buyer :<a href="#">Vishal Gupta </a></span>
								</div>
							</div>
							<div class="media">
								<h5>BEAUTY & BEAST</h5>
								...
								<div class="media-body">
									<p>OMG What a smartphone i am a big fan of sony and this is the beauty & beast</p>
									<span>Certified Buyer :<a href="#">arshad khan </a></span>
								</div>
							</div>

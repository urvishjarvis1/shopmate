...
include 'inc/dbh.php';
$sql = "SELECT * FROM price where name='sonyxz'";
		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>Xperia XZ First Look</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div data-video="QdY4IJguI0k" id="video"> <img src="images/xperiaxz.jpg" alt="" class="img-responsive" /> </div>
						</div>
					</div>
						...
						<div class="media-grids">
							<div class="media">
								...
								<div class="media-body">
									<p>Xperia xz... Great phone from Sony</p>
									<span>Certified Buyer :<a href="#">Dr R RAJA MURUGAN </a></span>
								</div>
							</div>
							<div class="media">
								...
								<div class="media-body">
									<p>Powerful Fone! Excellent Camera & Battery1</p>
									<span>Certified Buyer :<a href="#">Rj Amar </a></span>
								</div>
							</div>
							<div class="media">
								<h5>Mind-blowing purchase</h5>
								...
								<div class="media-body">
									<p>It has been 8 days using Xperia XZ and great performance, great camera. Superb phone</p>

...
include 'inc/dbh.php';
$sql = "SELECT * FROM price where name='iphone6s'";
		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>iPhone 6s First Look</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div data-video="2gHeBVyqJRo" id="video"> <img src="images/iphone6s.jpg" alt="" class="img-responsive" /> </div>
						</div>
					</div>
						...
						<div class="media-grids">
							<div class="media">
								...
								<div class="media-body">
									<p>Extremely expensive, with this amount you can get a good motorcycle at your home and believe me it will be more useful than this. Will ultimately will become outdated in next 6 months.</p>
									<span>Certified Buyer :<a href="#">Pradeep Kandari </a></span>
								</div>
							</div>
							<div class="media">
								<h5>Best iPhone but Overpriced !!!!!!!!</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>Everything is good about this iPhone except its Price :( People out there waiting for this iPhone including me from a very long time but unable to buy this due its over-price. I hope Apple India will realise this and soon bring its price down and will see some happy customers :) Cheers to those who are enjoying there brand new iPhone 6s (y)</p>
									<span>Certified Buyer :<a href="#">Nitish kumar </a></span>
								</div>
							</div>
							<div class="media">
								<h5>Awesome performance</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>But buy With WS Retailer only...price comfortable ...plz don't buy other retailer frm flipkart...</p>
									<span>Certified Buyer :<a href="#">Rajesh Reddy </a></span>
								</div>
							</div>

...
if(!$row = $result->fetch_assoc()){
 ...
 $sql = "SELECT * FROM price where name='pixelxl'";
		...
		<!-- /w3l-medile-movies-grids -->
			...
			<div class="single-page-agile-info">
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3>Google Pixel First Look</h3>	
					</div>
						<div class="video-grid-single-page-agileits">
							<div data-video="Rykmwn0SMWU" id="video"> <img src="images/pixel1.jpg" alt="" class="img-responsive" /> </div>
						</div>
					</div>
					...
					<div class="clearfix"> 
						<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
							...
							<div id="flip">Click to get best deal pixel!!</div>
							...
							$("#panel1").slideToggle("slow");
								...
								<div id="flip1">Click to get best deal for pixel xl!!</div>
						...
						<div class="media-grids">
							<div class="media">
								...
								<div class="media-body">
									<p>Awesome product. Received it today. The delivery was very quick . The product is took good so far.</p>
									<span>Certified Buyer :<a href="#">Ashwin S </a></span>
								</div>
							</div>
							<div class="media">
								<h5>Mind-blowing purchase</h5>
								<div class="media-left">
									<a href="#">
									<img src="images/user.jpg" title="One movies" alt=" " />
									</a>
								...
								<div class="media-body">
									<p>The feel you get when you hold this phone can't be expressed. Just the perfect size. And the camera is the best in market. Compare to iPhone it definitely competes. Battery has been good so far. It took around 45 minutes for its full charging. Assistant can do anything for you. In all its the best thing I ever purchased.</p>
									<span>Certified Buyer :<a href="#">Somesh M</a></span>
								</div>
							</div>
							<div class="media">
								...
								<div class="media-body">
									<p>Worth the money.... elegant design... rocking camera.... after NEXUS felt this as another good phone in my hand... Got a surprise gift(chocolates) from Flipkart and delivery timing was on the mark...


V happy with performance , battery, design...

Looking for better Pixel case now..</p>
									<span>Certified Buyer :<a href="#">Rakesh Gupta </a></span>
								</div>
							</div>
